...
while True:
    ...
    if window==jan_info and event=="Confirmar":
        if values["ci"]==True:
            sg.popup("A capital do nordeste")

        elif values["inf"]==True:
            sg.popup("A cidade tem ...anos,é conhecida por sua cultura,pelo seu clima e seus pontos turisticos são os mais visitados do Brasil")
